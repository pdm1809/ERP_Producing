...
[Keyless]
[Table("ImportIngrediantPaint")]
public partial class ImportIngrediantPaint
{
    [Column("ICProductNo")]
    [StringLength(50)]
    ...
    [Column("ICProductAttribute05")]
    [StringLength(50)]
    public string IcproductAttribute05 { get; set; }
    ...
    [StringLength(50)]
    public string IcproductLeadTime { get; set; }
