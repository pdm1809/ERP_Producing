...
[Table("PMProjectProfiles")]
[Microsoft.EntityFrameworkCore.Index("PmprojectProfileNo", Name = "Idx_PMProjectProfiles")]
public partial class PmprojectProfile
{
    [Key]
    [Column("PMProjectProfileID")]
    public int PmprojectProfileId { get; set; }
    ...
    [Column("PMProjectProfileEstimatedTotalCost", TypeName = "decimal(18, 5)")]
    public decimal? PmprojectProfileEstimatedTotalCost { get; set; }

    [Column("PMProjectProfileActualTotalCost", TypeName = "decimal(18, 5)")]
    public decimal? PmprojectProfileActualTotalCost { get; set; }

    [InverseProperty("FkPmprojectProfile")]
