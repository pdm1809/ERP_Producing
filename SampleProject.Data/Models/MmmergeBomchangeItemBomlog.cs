...
[Table("MMMergeBOMChangeItemBOMLogs")]
public partial class MmmergeBomchangeItemBomlog
{
    [Key]
    [Column("MMMergeBOMChangeItemBOMLogID")]
    public int MmmergeBomchangeItemBomlogId { get; set; }

    [Column("FK_MMMergeBOMChangeID")]
    public int? FkMmmergeBomchangeId { get; set; }

    [Column("FK_MMProductionNormItemLogID")]
    public int? FkMmproductionNormItemLogId { get; set; }
    ...
    [InverseProperty("MmmergeBomchangeItemBomlogs")]
