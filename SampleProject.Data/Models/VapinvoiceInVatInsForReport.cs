...
[Keyless]
public partial class VapinvoiceInVatInsForReport
{
    [Column("APInvoiceInReferenceID")]
    public int ApinvoiceInReferenceId { get; set; }

    [Column("APInvoiceInItemReferenceID")]
    public int ApinvoiceInItemReferenceId { get; set; }
    ...
    [Column("APInvoiceInNetAmount", TypeName = "decimal(38, 6)")]
    public decimal? ApinvoiceInNetAmount { get; set; }

    [Column("APInvoiceInNetAmountByCurrency", TypeName = "decimal(38, 11)")]
    ...
    [Column("APInvoiceInTaxAmount", TypeName = "decimal(38, 6)")]
    public decimal? ApinvoiceInTaxAmount { get; set; }

    [Column("APInvoiceInTotalTaxAmount", TypeName = "decimal(38, 5)")]
    public decimal? ApinvoiceInTotalTaxAmount { get; set; }
}
